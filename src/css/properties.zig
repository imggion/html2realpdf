...
pub const document_profile = [_]PropertySupport{
    ...
    .{ .name = "break-after", .stage = layout, .notes = "page and facing-page forced breaks plus avoid arbitration" },
    .{ .name = "break-before", .stage = layout, .notes = "page and facing-page forced breaks plus first-child propagation" },
    .{ .name = "break-inside", .stage = layout, .notes = "avoid page fragmentation unless a descendant forces a break" },
