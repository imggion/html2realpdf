...
test("release resolution accepts the package tag on main HEAD", () => {
...
test("release resolution rejects a tag outside main HEAD", () => {
  assert.throws(() => resolveRelease({
    tags: ["v0.1.0-rc1"],
    packageVersion: "0.1.0-rc1",
    headSha: "main-sha",
    resolveTagSha: () => "tag-sha",
  }), /points to tag-sha, but main HEAD is main-sha/);
});
